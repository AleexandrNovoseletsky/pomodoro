...
from app.core.exceptions.integrity import IntegrityDBError
from app.core.exceptions.object_not_found import ObjectNotFoundError
...
class CRUDService:
    ...
    async def create_object_with_author(
        ...
        Вместо непосредственного изменения переданной Pydantic-модели
        создаём новый объект того же класса с добавленным полем.
        """
        try:
